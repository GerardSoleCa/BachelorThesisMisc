...
namespace Microsoft {
	namespace SPOT {
		namespace Hardware {
			...
			{
//                                Console::WriteLine("Port constructor");
				Id_var = (Cpu::Pin)(0);
				this->setId(portId);
				GPIOManager::getInstance()->Export(portId);
 //                               Console::WriteLine("Port constructor OK");
			}
			Port::Port(Cpu::Pin portId, bool initialState)
			{
 //                           	Console::WriteLine("Port constructor 2");
				this->setId(portId);
				GPIOManager::getInstance()->Export(portId);
//                                Console::WriteLine("Port constructor 2 OK");
			}
			Port::Port(Cpu::Pin portId, bool initialState, bool glitchFilter, Port::ResistorMode resistor)
			{
  //                              Console::WriteLine("Port constructor 3");
				this->setId(portId);
				throw new NotImplementedException();
    //                            Console::WriteLine("Port constructor 3 OK");
			}
