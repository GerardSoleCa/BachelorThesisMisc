...
namespace System{
	namespace Threading{
		...
		{
			if(milliseconds < 0) while(1){ boost::this_thread::sleep(boost::posix_time::milliseconds(5000));}
			
//				boost::posix_time::milliseconds putoTime(1000*60*5);
//				boost::this_thread::sleep(putoTime);
