...
\newglossaryentry{I2C}{name={I$^{2}$C},description={Inter-Integrated Circuit is a multimaster serial single-ended computer bus}}
...
\newglossaryentry{RX}{name={RX},description={Reception Channel}}
\newglossaryentry{TX}{name={TX},description={Transmission Channel}}
\newglossaryentry{HAL}{name={HAL},description={Hardware Abstraction Layer}}
\newglossaryentry{PAL}{name={PAL},description={Platform Abstraction Layer}}
\newglossaryentry{RPL}{name={RPL},description={IPv6 Routing Protocol for Low-Power and Lossy Networks}}
%\printglossaries
%\cleardoublepage